...
<body>
  ...
  <div class="container main">
    ...
    <div class="img-box">
      ...
      $image_query = mysqli_query($result, "select food_ID,name, price, image from food");
        ...
        <div class="menu-item-tile col-md-6">
          <div class="row">
            ...
            <div class="menu-item-description col-sm-7">
              ...
              <input type="submit" value="Update" name="btn_upload" class="btn" />
              <input type="submit" value="Delete" name="btn_upload" class="btn" />
            </div>
          </div>
          <hr class="visible-xs" />
        </div>
