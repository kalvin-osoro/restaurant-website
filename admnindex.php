      ...
      <div class="container">
        ...
        <div id="collapsable-nav" class="collapse navbar-collapse">
          <ul id="nav-list" class="nav navbar-nav navbar-right">
            ...
            <li>
              <a href="upload.php">
                <span class="glyphicon glyphicon-plus"></span><br class="hidden-xs" />
               add
              </a>
            </li>
            <li>
              <a href="update.php">
                <span class="glyphicon glyphicon-edit"></span><br class="hidden-xs" />
                Edit
              </a>
            </li>
            <li>
              <a href="orders.php">
                <span class="glyphicon glyphicon-list-alt"></span><br class="hidden-xs" />
                orders
              </a>
            </li>
            <li>
